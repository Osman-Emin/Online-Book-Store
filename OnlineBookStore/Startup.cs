...
using OnlineBookStore.Infrastructure.ApplicationUserClaims;
using OnlineBookStore.Infrastructure.AppSettingsModels;
using OnlineBookStore.Infrastructure.Startup;
...
namespace OnlineBookStore
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.Cookie.Name = "OnlineBookStore.AppCookie";
            ...
            services.AddSession(options =>
            {
                ...
                options.Cookie.Name = "OnlineBookStore.SessionCookie";
                // You might want to only set the application cookies over a secure connection:
                // options.Cookie.SecurePolicy = CookieSecurePolicy.Always;
                options.Cookie.SameSite = SameSiteMode.Strict;
                options.Cookie.HttpOnly = true;
